...
First launch of a packaged `.app` runs **install setup**: network helper (admin), Accessibility TCC prompt + Settings, and MAME **0.288** only (will not `brew install` a newer formula).
